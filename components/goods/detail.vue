    ...
    <div>
        ...
        <div class="product-desc">
            <ul>
                ...
                <li class="number-li">购买数量：<span @click="subsract">-</span><span>{{tmpNum}}</span><span @click="add">+</span></li>
                <li>
        ...
        <transition name="ball" v-on:after-enter="afterEnter">
            <div class="ball" v-show="showAbel"></div>
        </transition>
...
export default {
    data() {
        ...
        this.$http.get(this.config.apiPath + '/api/getthumimages/' + goodsId)
            .then(res => {
                this.imgs = res.body.message;
            }, res => {

            });
        this.getProInfo(goodsId);
    }, methods: {
        getProInfo(id) {
            this.$http.get(this.config.apiPath + `/api/goods/getinfo/${id}`)
                .then(res => {
